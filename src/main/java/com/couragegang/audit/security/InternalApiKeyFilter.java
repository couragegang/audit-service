...
import com.couragegang.audit.api.dto.AuditModels.ErrorBody;
...
public class InternalApiKeyFilter implements HttpServerFilter {
    ...
    public static final String HEADER = "X-Audit-Internal-Key";

    private final String expectedKey;

    public InternalApiKeyFilter(@Value("${audit-service.internal-api-key}") String expectedKey) {
